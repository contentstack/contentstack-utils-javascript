...
describe('Node parser reference content', () => {
    it('Should render reference asset to html from Entry',  done => {
        ...
        expect(entry.single_rte).toEqual('<img src="/v3/assets/blt333/blt44asset/dummy.pdf" alt="dummy.pdf" />')
        expect(entry.multiple_rte).toEqual(['<img src="/v3/assets/blt333/blt44asset/dummy.pdf" alt="dummy.pdf" />'])
        done()
    })
    ...
    it('Should render reference asset to html from Entries',  done => {
        ...
        expect(entry[0].single_rte).toEqual('<img src="/v3/assets/blt333/blt44asset/dummy.pdf" alt="dummy.pdf" />')
        expect(entry[0].multiple_rte).toEqual(['<img src="/v3/assets/blt333/blt44asset/dummy.pdf" alt="dummy.pdf" />'])
        done()
    })
